...
- **Spec:** `docs/superpowers/specs/2026-07-31-frontend-rebuild-design.md` —
...
- **Audit:** the 2026-07-31 comprehensive frontend audit that drove all of
  ...
  `docs/superpowers/plans/2026-07-31-frontend-rebuild-m1-foundation-ledger.md`.
...
memory. Copy it into `docs/superpowers/plans/` before deleting the workspace,
as M1 did, so carry-forwards survive.
...
```
docs/superpowers/specs/2026-07-31-frontend-rebuild-design.md   the blueprint
docs/superpowers/plans/2026-07-31-frontend-rebuild-m1-foundation.md
docs/superpowers/plans/2026-07-31-frontend-rebuild-m1-foundation-ledger.md
docs/superpowers/plans/2026-08-01-frontend-rebuild-m2-auth.md  current plan

...
Add a note to `docs/specs/2026-07-28-design-system.md` that its palette rationale remains authoritative while the full system lives in `docs/archive/2026-07-frontend-rebuild/specs/2026-07-29-full-design-system-replacement-design.md`. Update README links to the specification, plan, and `/design-system` proof surface.

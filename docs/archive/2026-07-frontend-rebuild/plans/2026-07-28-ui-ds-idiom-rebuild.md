...
**Goal:** Rebuild all five NabaPresence views onto the design system's components and conventions (spec: `docs/archive/2026-07-frontend-rebuild/specs/2026-07-28-ui-ds-idiom-rebuild-design.md`) with zero behaviour or API change.

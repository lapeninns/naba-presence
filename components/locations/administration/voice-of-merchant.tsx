...
export function VoiceOfMerchantSummary({ data }: { data: RawRecord }) {
  ...
  return (
    <div className="flex min-h-(--np-row-h) flex-wrap items-center justify-between gap-3 px-4 py-3">
      ...
      <StatusPill tone={verified ? "healthy" : "attention"}>
...
export function GoogleUpdateSummary({ data }: { data: RawRecord }) {
  ...
  return (
    <div className="flex min-h-(--np-row-h) flex-col justify-center gap-2 px-4 py-3">

...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-(--nr-radius-field) border text-sm transition-colors duration-(--nr-duration-fast) outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {

...
const SIDEBAR_WIDTH = "var(--nr-sidebar-width)"
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating"
            ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(var(--nr-sidebar-margin)*2))]"
            : variant === "inset"
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating"
            ? "p-(--nr-sidebar-margin) group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(var(--nr-sidebar-margin)*2))]"
            : variant === "inset"
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-(--nr-radius-shell) group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border/70 group-data-[variant=floating]:bg-sidebar/85 group-data-[variant=floating]:shadow-(--nr-shadow-float) group-data-[variant=floating]:backdrop-blur-xl"
        >
          {children}
        </div>
      </div>

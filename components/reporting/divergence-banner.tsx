...
// The warning variant supplies its own leading glyph.
export function DivergenceBanner({
  ...
  return (
    <Alert variant="warning">
      ...
      <AlertDescription>
        Google reports a different review total or rating than we have collected
        so far, so the numbers below may be behind or missing some reviews. They
        will settle as syncing catches up.
      </AlertDescription>
    </Alert>
  )
}
